...
const addAnimeSchema = Joi.object({
    ...
    series_status: Joi.string().valid("currently_airing", "finished_airing", "not_aired_yet", "postponed", "canceled").required(),
    trans_status: Joi.string().valid("currently_airing", "finished_airing", "not_aired_yet", "postponed", "canceled").required(),
