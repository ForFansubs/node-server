...
const getPath = (manga_slug, episode_number, filename) => Path.resolve(__dirname, `../images/manga_episodes/${manga_slug}${episode_number ? `/${episode_number}` : ""}${episode_number && filename ? `/${filename}` : ""}`)
...
module.exports = { clearMangaFolder, deleteMangaFolder, deleteMangaFolders, getPath }